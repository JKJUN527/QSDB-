                ...
                <ul class="nav side-menu">
                    <li @if($activeIndex == 0) class="active" @endif>
                        ...
                        <ul class="nav child_menu">
                            <li @if($activeIndexSecend == 0) class="current-page" @endif><a href="/qsdb/region">区域管理</a></li>
                            <li @if($activeIndexSecend == 1) class="current-page" @endif><a href="/qsdb/products">产品模块管理</a></li>
